...
<section class="">
    <div class="garagevector ">
        <img src="assets/images/vector-servicecenter.png" alt="">
    </div>
    <div class="defaultcard topgarage serv-c">
        <div class="garagetxthead">
            <h5>Register Your Service Center With Us.</h5>
        ...
        <div class="ourservices">
            <div class="pro-service">
                ...
                <div class="proservicetxt">
                    <p>Service Center Will Be On Internet</p>
                </div>
            </div>
...
<div class="defaultcard serv-c vegow">
    ...
    <div class="timeline">
        ...
        <div class="textcol">
            <p>Customer searches for nearby Service Center with the help of VeGO.</p>
        </div>
    </div>
    ...
    <div class="timeline">
        ...
        <div class="textcol">
            <p>This is how Customer find your Service Center and number of Customers get increased !</p>
        </div>
    </div>
</div>
...
<section>
    <div class="defaultcard serv-c">
        ...
        <div class="regbtn-cont">
            ...
            <a href="registerservicecenterform.html" class="btn enbtn">Register</a>
        </div>
